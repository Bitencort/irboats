    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top scrolling-navbar navbar-transparente">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a href="<?php echo base_url('/'); ?>" class="navbar-brand"><img class="img-fluid logo-site" src="<?php echo base_url('public/restrita/assets/img/logo.png'); ?>" alt="logo-cabecalho"></a>
            </div>
