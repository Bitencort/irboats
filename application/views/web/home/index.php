    ...
    <div id="main-slide" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100 img-fluid" src="<?php echo base_url('public/web/assets/img/banner/irboats-slide.jpg')?>" alt="irboats-manso">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="<?php echo base_url('public/web/assets/img/banner/barco.jpg')?>" alt="irboats-manso">
                <div class="carousel-caption d-md-block">
