 ...
 */
$config['site_title']                 = "Irboats";       // Site Title, example.com
$config['admin_email']                = "irboatscuiaba@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'anunciantes';           // Default group, use name
