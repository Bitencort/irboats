        ...
        $('[name=user_cep]').focusout(function () {
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    ...
                    //Definifir disables e apagar erros de validação
                ...
                success: function (response) {
                    ...
                    if (response.erro === 0) {
                       ...
                       // caso seje um cep que nao tenha o endereço eu habilito o campo para ser preenchido
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.erro === 0) {
                        ...
                        $('#box-foto-usuario').html("<input type='text' name='user_foto' value='" + response.user_foto + "'> <img width='100' alt='Usuário image' src='" + BASE_URL + "/uploads/usuarios/small/" + response.user_foto + "' class='rounded-circle'>");
